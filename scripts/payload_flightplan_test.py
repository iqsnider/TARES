...
flying every leg of a SafeFlightPlan in sequence instead of a single SafeTrajectory.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        # ENU to ENU. payload_trajectories() yields the payload reference for
        # each leg of the plan, in order, each one starting from wherever the
        # drone is once the previous leg finishes.
        ...
        for i, ref in enumerate(plan.payload_trajectories(), start=1):
